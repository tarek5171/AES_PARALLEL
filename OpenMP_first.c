...
#define AES_SIZE 16 // Assuming AES block size is 16 bytes
...
int main() {
    char inputString[] = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.";
    ...
    int blocks_per_thread = length / (NUM_THREADS * BLOCK_SIZE);
  ...
  double start_time = omp_get_wtime();
    ...
    #pragma omp parallel
    {
        ...
        char inputString[] = "YOUR_LONG_TEXT_HERE";
    ...
    printf("thread %d - Encrypted portion: ", rank);
    ...
    printf("thread %d - Decrypted portion: ", rank);
    for (int i = 0; i < portionLength; i++) {
        printf("%c", portion[i]);
    }
    printf("\n");
